...
const renderInfo = async function () {
  ...
  <div class="user__img">
          ...
          <div class="profile__info__wrapper">
            <div class="user__wrapper">
              <div class="user">
                <h1 class="user__name">${info.name}</h1>
                <a href="${info.html_url}" class="user__tag">@${info.login}</a>
              </div>
              <div class="date">
                <p class="join__date">Joined ${date}</p>
              </div>
            </div>

            <p class="profile__bio">
              ${!info.bio ? 'This user has no bio.' : info.bio}
            </p>

            <div class="stats__container">
              <div class="repos__wrapper">
                <p class="stat">Repos</p>
                <span class="total">${info.public_repos}</span>
              </div>
              <div class="repos__wrapper">
                <p class="stat">Followers</p>
                <span class="total">${info.followers}</span>
              </div>
              <div class="repos__wrapper">
                <p class="stat">Following</p>
                <span class="total">${info.following}</span>
              </div>
            </div>

            <div class="general__info__container">
              <div class="info">
                <svg
                  height="20"
                  width="14"
              ...
              <div class="info">
                ...
                <a href="${!info.blog ? '#' : info.blog}" class="website">${
    !info.blog ? 'Not available.' : info.blog
  }</a>
              </div>
              ...
              <div class="info">
                ...
                <span class="company">${
                  !info.company ? 'Not available.' : info.company
                }</span>
              </div>
            </div>
          </div>
  ...
  userInfoEl.insertAdjacentHTML('afterbegin', html);
};
